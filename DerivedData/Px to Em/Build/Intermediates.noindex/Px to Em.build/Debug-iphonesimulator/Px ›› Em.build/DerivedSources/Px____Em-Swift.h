...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Px____Em",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8Px____Em11AppDelegate")
...
SWIFT_CLASS("_TtC8Px____Em13SceneDelegate")
...
@interface SceneDelegate (SWIFT_EXTENSION(Px____Em)) <UIGestureRecognizerDelegate>
